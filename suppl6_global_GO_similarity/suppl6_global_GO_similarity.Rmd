---
title: "Supplementary file 6. Global GO term similarity"
...
```{r, eval = !file.exists("/icgc/dkfzlsdf/analysis/B080/guz/simplifyGO_test/rds/all_bp_sim.rds")}
library(GOSemSim)
...
```{r, eval = !file.exists("/icgc/dkfzlsdf/analysis/B080/guz/simplifyGO_test/rds/all_bp_sim.rds"), echo = FALSE}
saveRDS(sm, file = "/icgc/dkfzlsdf/analysis/B080/guz/simplifyGO_test/rds/all_bp_sim.rds")
```

```{r, echo = FALSE, eval = file.exists("/icgc/dkfzlsdf/analysis/B080/guz/simplifyGO_test/rds/all_bp_sim.rds")}
sm = readRDS("/icgc/dkfzlsdf/analysis/B080/guz/simplifyGO_test/rds/all_bp_sim.rds")
```
...
To simplify the similarity matrix, the GO terms which locate as leaves in the GO tree are removed.
These leaf terms only have similarity with themselves, thus they have zero similarity to all other terms.
...
```{r, eval = !file.exists("/icgc/dkfzlsdf/analysis/B080/guz/simplifyGO_test/rds/all_bp_sim_cl.rds")}
# This takes around 30 min
cl = cluster_terms(sm2, method = "louvain")
```

```{r, echo = FALSE, eval = !file.exists("/icgc/dkfzlsdf/analysis/B080/guz/simplifyGO_test/rds/all_bp_sim_cl.rds")}
saveRDS(cl, file = "/icgc/dkfzlsdf/analysis/B080/guz/simplifyGO_test/rds/all_bp_sim_cl.rds")
```

```{r, echo = FALSE, eval = file.exists("/icgc/dkfzlsdf/analysis/B080/guz/simplifyGO_test/rds/all_bp_sim_cl.rds")}
cl = readRDS("/icgc/dkfzlsdf/analysis/B080/guz/simplifyGO_test/rds/all_bp_sim_cl.rds")
```
